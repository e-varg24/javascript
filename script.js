...
// if user selects no to call password criteria this alert + confirm loop will happen
...
//generate string of characters based on user criteria
...
if (confirmnumber) {
      ...
      // generate final passwrod by randomizing + length
...
function writePassword() {
  ...
  // generates password and displays
  passwordText.value = password;
}

 // Add event listener button-> when user clicks it calls for the write password fx
